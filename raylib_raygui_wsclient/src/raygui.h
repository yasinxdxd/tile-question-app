...
RAYGUIAPI int GuiButtonTile(float x, float y, float sx, float sy, const char *text);
RAYGUIAPI int GuiTextBoxTile(float x, float y, float sx, float sy, char *text, int textSize, bool editMode);
